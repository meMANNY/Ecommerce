...
export const Navbar = () => {
 ...
 <nav className="h-20 flex border-b justify-between font-medium bg-white">
    ...
    <div className="hidden lg:flex">
        ...
        <Button asChild className="border-l border-t-0 border-b-0 text-white border-r-0 rounded-none px-12 h-full bg-black hover:bg-pink-400 hover:text-black transition-colors text-lg">
        <Link href="/sign-up">
          Start Selling
        </Link>
        </Button>
